...
if (isset($_POST['submitform'])){
	...
	if (!empty($_POST['nama_lengkap']) && !empty($_POST['email']) && !empty($_POST['nomor_whatsapp']) && !empty($_POST['detail_masalah'])){
		...
		$queryform = "INSERT INTO finansialform (nama_lengkap, email, nomor_whatsapp, detail_masalah) VALUES ('$nameform', '$emailform', '$nowhatsapp', '$masalah')" ;
    ...
    if ($run) {
      echo "<script>
			...
			document.location.href='form-finansial.php';
			</script>";
    } else {
      echo "<script>
    ...
    <div class="container-contact100">
      <div class="wrap-contact100">
        <form action="" method="POST" class="contact100-form validate-form" id="whatsapp">
          <span class="contact100-form-title">FINANCIAL FORM</span>
          ...
          <div class="wrap-input100">
            ...
            <label>
              <input class="input100 nowhatsapp" type="email" name="email" />
            </label>
            <span class="focus-input100"></span>
          </div>
